...
enabled with a budget that **resets every day**. Live counter: **9 remaining for 2026-06-16** (published today: SNPS). Previous day 2026-06-15 published: NVDA, ADBE, INTU, CDNS, FTNT (5). Day before 2026-06-14 published: PANW, ORCL, AMD (+ CRM refresh). New 10/day all-Opus budget now in effect (set 2026-06-15, superseding the prior 5/day all-Opus budget).
